...
### Output
The plugin generates three files, a [detailed report](assets/co2footprint_report_sample.html), a [text summary](assets/co2footprint_report_sample.html), and a [trace file](assets/co2footprint_report_sample.html) for more information have a look at the [output](usage/output.md) section.
