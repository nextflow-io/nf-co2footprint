...
class CO2FootprintFactory implements TraceObserverFactory {
    ...
    Collection<TraceObserver> create(Session session) {
        ...
        log.info('🔕 Repeated logging messages for different tasks are shown only once in the console; further occurrences are logged at DEBUG level and appear only in the `.nextflow.log` file.')
