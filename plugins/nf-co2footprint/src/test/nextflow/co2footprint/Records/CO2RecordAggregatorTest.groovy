...
class CO2RecordAggregatorTest extends Specification{
    ...
    def 'Test stat computation'() {
        ...
        stats == [
                ...
                energy_personalEnergyMix:   [all: [0.0, 1.0, 2.0], total: 3.0, mean: 1.0, minLabel: 'testTask_1', min: 0.0, q1Label: 'testTask_1', q1: 0.5, q2Label: 'testTask_2', q2: 1.0, q3Label: 'testTask_2', q3: 1.5, maxLabel: 'testTask_3', max: 2.0],
        ]
    }
}
