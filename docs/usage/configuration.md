...
Currently, **nf-co2footprint** does not natively support cloud environments because cloud-specific instance types may not be included in the TDP table, and default PUE values for cloud providers are missing.
